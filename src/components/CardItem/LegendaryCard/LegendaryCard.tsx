...
const LegendaryCard = ({ imageFace, imageStyle, sizeTag }: any) => {
        ...
        case 0:
            return (
                ...
                >
                    ...
                    >
                        <motion.div className="card_legendary normal_size eevee">
            ...
            return (
                ...
                >
                    <motion.div
                        ...
                        whileHover={{ scale: 1.2 }}
                    >
                        <motion.div className="card_legendary medium_size eevee">
                            <ImageHandler name={imageFace} imageStyle={imageStyle} />
                        </motion.div>
                    </motion.div>
                </motion.div >
            ...
            return (
                ...
                >
                    <motion.div
                        ...
                        whileHover={{ scale: 1.2 }}
                    >
                        <motion.div className="card_legendary large_size eevee">
                            <ImageHandler name={imageFace} imageStyle={imageStyle} />
                        </motion.div>
                    </motion.div>
                </motion.div >
