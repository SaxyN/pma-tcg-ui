...
const GoldCard = ({ imageFace, imageStyle, cardUID, sizeTag }: any) => {
        ...
        case 0:
            return (
                ...
                >
                    ...
                    >
                        <motion.div className="card_gold normal_size eevee">
            ...
            return (
                ...
                >
                    <motion.div
                        ...
                        whileHover={{ scale: 1.2 }}
                    >
                        <motion.div className="card_gold medium_size eevee">
                            <ImageHandler name={imageFace} imageStyle={imageStyle} />
                        </motion.div>
                    </motion.div>
                </motion.div >
            ...
            return (
                ...
                >
                    <motion.div
                        ...
                        whileHover={{ scale: 1.2 }}
                    >
                        <motion.div className="card_gold large_size eevee">
                            <ImageHandler name={imageFace} imageStyle={imageStyle} />
                        </motion.div>
                    </motion.div>
                </motion.div >
